  ...
  <div className="container">
      ...
      <div className="programs-cards-container">
        <div className="programs-card-1">
          <img
            ...
            src="https://res.cloudinary.com/dhfmjj1j9/image/upload/v1719213809/Group_73_ir4v77.png"
            alt="programs"
          />
          <h1 className="sport-programs-head">Sport Class</h1>
          <p className="sport-programs-desc">
            Each day at EduKid is a celebration. We celebrate all sports!
          </p>
          <button type="button" className="sport-view-details-btn">
            View Details
          </button>
        </div>
        <div className="programs-card-2">
          <img
            className="programs-img"
            src="https://res.cloudinary.com/dhfmjj1j9/image/upload/v1719215293/Group_74_ey3e0o.png"
            alt="programs"
          />
          <h1 className="music-programs-head">Music Class</h1>
          <p className="music-programs-desc">
            Musical indoor and outdoor activities that cater to all domains
            development!
          </p>
          <button type="button" className="music-view-details-btn">
            View Details
          </button>
        </div>
        <div className="programs-card-1">
          <img
            className="programs-img"
            src="https://res.cloudinary.com/dhfmjj1j9/image/upload/v1719215504/Group_72_dsanl9.png"
            alt="programs"
          />
          <h1 className="drawing-programs-head">Drawing Class</h1>
          <p className="drawing-programs-desc">
    ...
    <div className="programs-bg-container-2">
      <div className="programs-banner-container">
        <img
          className="programs-banner-img"
          src="https://res.cloudinary.com/dhfmjj1j9/image/upload/v1719220810/Group_97_euwwl0.png"
          alt="programs-banner"
        />
      </div>
      <div className="programs-content-container-2">
        <h1 className="programs-head-2">Our Programs</h1>
        <p className="programs-desc-2">
        ...
        <div className="programs-lists-container">
          <div className="programs-list-container">
            ...
            <p className="programs-list-desc">
        ...
        <button type="button" className="programs-view-details-btn">
          View Details
        </button>
      </div>
    </div>
    <div className="programs-bg-container-3">
      ...
      <p className="programs-desc-3">
        EduKid opened its doors in 1998 with a unique vision to provide students
      ...
      <div className="programs-cards-container-sports">
        <div className="programs-card-container-sports">
          <div className="programs-card-content-container">
            <img
              src="https://res.cloudinary.com/dhfmjj1j9/image/upload/v1719228472/Rectangle_88_q7u1zu.png"
              alt="programs"
            />
            ...
            <div className="sports-card-dashboard-container-1">
              <div className="sports-card-dashboard-content-container">
                <h1 className="sports-card-dashboard-head">
                  4-5
                  <br />
                  yrs
                </h1>
        ...
        <div className="programs-card-container-sports">
          <div className="programs-card-content-container">
            <img
              src="https://res.cloudinary.com/dhfmjj1j9/image/upload/v1719298810/Rectangle_89_thsgy6.png"
              alt="programs"
            />
            <h1 className="sports-card-head">Play Group</h1>
            <p className="sports-card-desc">
              We will be magically transforming the School’s Sports Center into
              a full game area.
            </p>
        ...
        <div className="programs-card-container-sports">
          <div className="programs-card-content-container">
            <img
              src="https://res.cloudinary.com/dhfmjj1j9/image/upload/v1719299193/Rectangle_90_hq2ztf.png"
              alt="programs"
            />
